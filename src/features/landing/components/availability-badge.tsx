...
export function AvailabilityBadge() {
  return (
    ...
    >
      <span className="inline-flex items-center gap-2 border border-white/[0.08] bg-white/[0.02] px-4 py-2 text-xs font-medium uppercase tracking-widest text-muted-foreground">
